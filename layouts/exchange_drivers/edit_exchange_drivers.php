        ...
        <form action="" method="post" style="width: 80vw; min-width: 350px;">
          ...
          <div class="row">
            ...
            <div class="col-md-2">
                ...
                <input type="text" class="form-control" value="<?php echo $row['service_value'] ?>" name="service_value" placeholder="Service Value">
            </div>
            <div class="col">
                 <br>
                <label for="service_type" class="form-label">نوع الخدمة</label>
                <input type="text" class="form-control" name="service_type" value="<?php echo $row['service_type'] ?>" id="service_type" placeholder="الدفعات">
            </div>
          </div><br>
